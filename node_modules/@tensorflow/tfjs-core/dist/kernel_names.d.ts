 ...
 * =============================================================================
 */
import { NamedTensorInfoMap, TensorInfo } from '@tensorflow/tfjs-core/dist/kernel_registry';
import { ExplicitPadding } from '@tensorflow/tfjs-core/dist/ops/conv_util';
import { Activation } from '@tensorflow/tfjs-core/dist/ops/fused_types';
import { DataType, PixelData } from '@tensorflow/tfjs-core/dist/types';
...
export declare type Conv3DBackpropFilterInputs = Pick<NamedTensorInfoMap, 'x' | 'dy'>;
...
export declare type Conv3DBackpropInputInputs = Pick<NamedTensorInfoMap, 'dy' | 'filter'>;
...
export declare type NegateInputs = UnaryInputs;
...
export declare type ResizeNearestNeighborGradInputs = Pick<NamedTensorInfoMap, 'images'>;
...
export declare type ResizeBilinearGradInputs = Pick<NamedTensorInfoMap, 'images'>;
