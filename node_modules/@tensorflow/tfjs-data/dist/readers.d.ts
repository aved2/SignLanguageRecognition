...
import { CSVConfig, MicrophoneConfig, WebcamConfig } from '@tensorflow/tfjs-data/dist/types';
/**
 ...
 *  }
 */
export declare function generator<T extends TensorContainer>(generator: () => Iterator<T> | Promise<Iterator<T>>): Dataset<T>;
/**
