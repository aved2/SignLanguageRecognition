 ...
 * =============================================================================
 */
import '@tensorflow/tfjs-backend-webgl/dist/flags_webgl';
import { DataId, MemoryInfo, RecursiveArray, TimingInfo } from '@tensorflow/tfjs-core';
import { backend_util } from '@tensorflow/tfjs-core';
import { DataStorage, DataType, KernelBackend, Rank, Scalar, ShapeMap, Tensor, Tensor1D, Tensor2D, Tensor3D, Tensor4D, Tensor5D, TensorInfo } from '@tensorflow/tfjs-core';
import { GPGPUContext } from '@tensorflow/tfjs-backend-webgl/dist/gpgpu_context';
import * as gpgpu_math from '@tensorflow/tfjs-backend-webgl/dist/gpgpu_math';
import { GPGPUProgram } from '@tensorflow/tfjs-backend-webgl/dist/gpgpu_math';
import { TextureData } from '@tensorflow/tfjs-backend-webgl/dist/tex_util';
...
export declare class MathBackendWebGL extends KernelBackend {
    ...
    makeTensorInfo(shape: number[], dtype: DataType, values?: BackendValues): TensorInfo;
    private makeOutput;
